      ...
      <div style={{display:"flex",alignItems:"center",gap:6,flexShrink:0}}>
        ...
        {user && (
          <div className="nav-links" style={{display:"flex",alignItems:"center",gap:4}}>
            <Link href="/history" style={{fontSize:12,color:"var(--text-3)",textDecoration:"none",
              padding:"4px 8px",borderRadius:6}}>
              History
            </Link>
            <Link href="/schema" style={{fontSize:12,color:"var(--text-3)",textDecoration:"none",
              padding:"4px 8px",borderRadius:6}}>
              Schema
            </Link>
          </div>
        ...
        {loading ? (
          ...
          <button onClick={signInWithGitHub} className="btn btn-primary btn-sm"
            style={{gap:5,fontSize:12,flexShrink:0}}>
